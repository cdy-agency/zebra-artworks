  ...
  return (
    <section className="bg-[#f6f7f9] py-20 px-6">
      <div className="max-w-5xl mx-auto text-center">
        ...
        {/* Text */}
        <p className="text-gray-600 mt-6 text-sm md:text-base leading-relaxed max-w-3xl mx-auto">
        ...
        <p className="text-gray-600 mt-4 text-sm md:text-base leading-relaxed max-w-3xl mx-auto">
