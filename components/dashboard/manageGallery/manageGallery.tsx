...
export default function ManageGalleryPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl p-6">
      <h1 className="mb-1 text-2xl font-bold text-foreground">Manage Gallery</h1>
      ...
      <div className="mb-8 rounded-xl border border-line/20 bg-subtle p-5">
        ...
        <p className="text-sm leading-6 text-gray-mid">
      ...
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <span className="text-sm text-gray-mid">{items.length} / 4 available</span>
      </div>

      {loading ? (
        <div className="flex items-center gap-2 py-8 text-sm text-gray-mid">
        ...
        <div className="rounded-xl border border-line/20 bg-background px-5 py-8 text-center">
          ...
          <p className="text-sm text-foreground">No project images available yet.</p>
          ...
          {items.map((item, idx) => (
            ...
            >
              <div className="relative h-44 w-full">
                ...
                />
                <span className="absolute left-2 top-2 rounded-full bg-primary px-2 py-0.5 text-[10px] font-bold text-background">
                  Slot {idx + 1}
                </span>
              </div>
              ...
              <div className="p-4">
                ...
                <p className="mt-1 line-clamp-2 text-xs text-gray-mid">
